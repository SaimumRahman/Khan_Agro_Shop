...
public class AdapterDetailsOrder extends RecyclerView.Adapter<AdapterDetailsOrder.ViewHolder> {

    private Context context;
    private List<Products> products;

    public AdapterDetailsOrder(Context context, List<Products> products) {
    ...
    @NonNull
    @Override
    public AdapterDetailsOrder.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RecylerLayoutBinding binding=RecylerLayoutBinding.inflate(LayoutInflater.from(parent.getContext()),parent,false);

        return new AdapterDetailsOrder.ViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterDetailsOrder.ViewHolder holder, int position) {
